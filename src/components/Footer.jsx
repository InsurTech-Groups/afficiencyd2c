...
const navigation = {
  main: [
    { name: 'Visit Us', href: 'https://insurtechgroups.com' },
    { name: 'Privacy Policy', href: 'https://insurtechgroups.com/privacy-policy' },
    { name: 'Terms & Conditions', href: 'https://insurtechgroups.com/terms-conditions' },
    { name: 'Do Not Contact', href: '#' },
